...
const topics = [
  ...
  "Как я учусь быть слабой и просить помощи у людей",
...
const CUSTOM_URLS: Record<string, string> = {
  ...
  "Как я учусь быть слабой и просить помощи у людей": "https://t.me/c/2474417642/393",
    ...
    <div className="app-stars min-h-screen flex flex-col items-center px-4 py-6">
      ...
      <div className="relative max-w-[343px] mx-auto mb-0" style={{ marginTop: "15px" }}>
        ...
        >
          ...
          >
            <p>
              — это психологические и астрологические разборы повседневных ситуаций из жизни Анны и других людей.
            </p>
            <p style={{ marginTop: "10px" }}>
              Они позволяют на любую ситуацию научиться смотреть с разных сторон, слушайте и делитесь обратной связью в чате. После каждого подкаста можно попасть на мини-разбор по теме подкаста.
            </p>
          </div>
        </div>
      </div>
